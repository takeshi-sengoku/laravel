...
Route::match(['get', 'post'], '/admin/search', 'AdminController@search')->name('admin@search');
Route::get('/admin/account/create', 'AdminController@accountCreate')->name('admin@account_create');
Route::match(['get', 'post'], '/admin/account/search', 'AdminController@accountSearch')->name('admin@account_search');
Route::match(['get', 'post'], '/admin/sentence/search', 'AdminController@sentenceSearch')->name('admin@sentence_search');
